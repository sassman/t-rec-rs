...
//! With screenshot: cargo run -p core-animation --example basic_layers --features screenshot
...
fn main() {
    ...
    // Show with optional screenshot at midpoint
    #[cfg(feature = "screenshot")]
    {
        use std::path::Path;
        window.show_for_with_screenshot(
            5.seconds(),
            Path::new("crates/core-animation/examples/screenshots/basic_layers.png"),
        );
    }
